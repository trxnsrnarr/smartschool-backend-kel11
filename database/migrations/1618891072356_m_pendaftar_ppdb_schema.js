  ...
  up() {
    this.create("m_pendaftar_ppdb", (table) => {
      ...
      table
        ...
        .onDelete("cascade")
        .onUpdate("cascade");
      table.integer("m_jurusan_1_id").unsigned().index();
      table
        .foreign("m_jurusan_1_id")
        .references("m_jurusan.id")
        .onDelete("cascade")
        .onUpdate("cascade");
      table.integer("m_jurusan_2_id").unsigned().index();
      table
        .foreign("m_jurusan_2_id")
        .references("m_jurusan.id")
        .onDelete("cascade")
        .onUpdate("cascade");
      table.integer("m_jurusan_3_id").unsigned().index();
      table
        .foreign("m_jurusan_3_id")
        .references("m_jurusan.id")
        .onDelete("cascade")
        .onUpdate("cascade");
      table.integer("m_jurusan_4_id").unsigned().index();
      table
        .foreign("m_jurusan_4_id")
        .references("m_jurusan.id")
        .onDelete("cascade")
        .onUpdate("cascade");
      table.integer("m_jurusan_5_id").unsigned().index();
      table
